...
function NotSaleProduct() {
      ...
      const getData = async () => {
        try {
          const [productResponse, brandResponse, categoryResponse] = await Promise.all([
            axios.get(`${URL}api/v1/product/getall/dontsale`),
  ...
  return (
    ...
    <div className='min-h-screen flex-col  flex md:w-full mx-4  mt-[65px]'>
        <h1 className='text-center text-3xl font-bold'>Danh sách sản phẩm ngưng kinh doanh</h1>
    <div className='min-h-screen h-auto flex-col  flex md:w-full w-full '>
    <div data-aos="fade-left" className='flex gap-6 flex-col  w-10/12  md:w-full h-auto relative mb-auto justify-center items-center  '>
...
data-aos="flip-left"
              ...
              className="flex flex-col bg-white w-full font-mono space-y-8 h-[600px] rounded-md py-4  border-2 border-red-500"
            >
