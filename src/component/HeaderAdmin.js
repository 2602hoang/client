...
function HeaderAdmin() {
  ...
  return (
    <div
      className=" justify-center flex fixed   items-center
    flex-row bg-[#539ba9]  h-[60px] md:w-full z-40 w-full top-0 left-0 right-0 "
    >
      <nav className=" justify-start items-center py-2 flex md:ml-6 max-w-6xl md:w-full w-full mx-2">
        <div className="md:flex top-0 left-0 right-0  z-50  md:z-50   md:w-1/5 flex flex-row md:mr-auto  ">
          <a
            href="/post"
            className="font-black flex  items-center gap-x-2 bg-clip-text text-transparent bg-gradient-to-r from-red-700 to-yellow-400"
          >
            <img
              src={background}
              className=" space-x-1 h-12 w-16 rounded-full"
            />
            Admin
          </a>
        </div>
        ...
        <ul
          ...
          className={`
            ...
            md:space-y-0
               bg-sky-300
                fixed z-20 top-0 left-0 w-full h-full flex font-bold flex-col justify-center items-center  ${
                  menuVisible
                    ? " h-screen overflow-y-visible fixed w-full"
                    : "invisible"
        ...
        >
          ...
          <li className="my-5 md:m-0 relative text-center">
            <a
              ...
              className="text-white hover:border-b-2 hover:border-red-500 hover:text-red-500 justify-center transition duration-500 ease-in"
            >
              Quản Lý Sản Phẩm{" "}
              {subMenuVisible1 ? (
            ...
            >
              <div
                className="md:w-[200px] flex flex-col rounded-br-lg
                             rounded-bl-lg space-y-4 mt-2 w-full p-2 md:bg-[#539ba9]
                              bg-sky-300 text-white  "
              >
                <li>
                  <a href="/productmanager">Tất cả sản phẩm</a>
                </li>
          ...
          <li className="my-5 md:m-0">
            ...
            >
              ...
              >
                <li>
                  <a href="/ordermanager">Đơn hàng cần xử lý</a>
                </li>
          ...
          <li className="my-5 md:m-0 text-center">
            ...
            >
              ...
              >
                <li>
                  <a href="/reportproduct">Thống kê sản phẩm</a>
                </li>
