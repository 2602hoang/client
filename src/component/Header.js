...
function Header() {
  ...
  return (
    ...
    flex-row bg-[#241f32]  h-[60px] md:w-full z-50 w-full top-0 '>
            ...
            md:space-y-0
               bg-sky-300
                fixed z-20 top-0 left-0 w-full h-full flex font-bold flex-col justify-center
                 items-center  ${menuVisible ? 'min-h-full' : 'invisible'
                    ...
                    <li className='my-5 md:m-0'>
                        <a href='/drink' className=' text-white hover:border-b-2 hover:animate-ping
                         hover:border-red-500 hover:text-red-500
                          transition duration-500 ease-in'>Về chúng tôi</a></li>
                    <li className='my-5 md:m-0'>
                        <a href='/food' className=' text-white hover:border-b-2 hover:animate-ping
                         hover:border-red-500 hover:text-red-500
                          transition duration-500 ease-in'>Sản phẩm</a></li>
                    <li className='my-5 md:m-0'>
                        <a href='/about' className=' text-white hover:border-b-2 hover:animate-ping
                         hover:border-red-500 hover:text-red-500
                          transition duration-500 ease-in'>Đơn Hàng Đã Đặt</a></li>
                    <li className='my-5 md:m-0'>
                        <a href='/contact' className=' text-white hover:border-b-2 hover:animate-ping
                         hover:border-red-500 hover:text-red-500
